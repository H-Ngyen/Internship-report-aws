...
Trong phần này, chúng ta sẽ deploy ứng dụng carbuyer-aws lên cả 2 EC2 instances và kết nối với ALB đã setup ở bước 5.6.4.

### Các bước thực hiện

#### 1. Deploy Customer Service

1. Kết nối vào Customer Service instance (đã kết nối từ bước 5.6.3)
...
AWS_ACCESS_KEY_ID=your_access_key_from_5.2.3
AWS_SECRET_ACCESS_KEY=your_secret_key_from_5.2.3
...
LAMBDA_EMAIL_API_KEY=your_api_key_from_5.5.4
...
1. Kết nối vào Admin Service instance (đã kết nối từ bước 5.6.3):
...
Tiếp theo chuyển sang [5.6.6 - Test Application](../5.6.6-test-application) để kiểm tra ứng dụng.