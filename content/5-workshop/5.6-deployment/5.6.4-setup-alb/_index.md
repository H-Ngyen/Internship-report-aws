...
- **VPC**: Chọn VPC đã tạo ở bước 5.2.1
...
**Step 2 - Register targets (recommended):**
...
DNS name này sẽ được sử dụng trong bước 5.6.5 để cấu hình applications
{{% /notice %}}
...
Tiếp theo chuyển sang [5.6.5 - Deploy Applications](../5.6.5-deploy-apps) để deploy ứng dụng và add instances vào Target Groups.