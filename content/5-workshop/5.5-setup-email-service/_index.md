...
1. [Setup IAM Role & Lambda Function](5.5.1-setup-iam-lambda/)
2. [Test Lambda Function](5.5.2-test-lambda/)
3. [Setup API Gateway](5.5.3-setup-api-gateway/)
4. [Setup API Security](5.5.4-setup-api-security/)

#### Thông tin cần lưu lại

Sau khi hoàn thành các bước, bạn cần lưu lại 2 thông tin quan trọng để sử dụng ở mục 5.6:

**1. API Gateway Invoke URL** (từ bước 5.5.3):
```
https://YOUR_API_ID.execute-api.ap-southeast-1.amazonaws.com/prod
```

**2. API Key** (từ bước 5.5.4):
```
...
{{% notice warning %}}
**Lưu ý quan trọng:**
Cả 2 thông tin này sẽ được sử dụng trong file cấu hình `.env` của ứng dụng ở mục 5.6.
{{% /notice %}}
