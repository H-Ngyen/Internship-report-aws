...
#### 9. Tạo Test Event cho Reset Password
...
#### 11. Tạo Test Event cho Booking Confirmation
...
#### 12. Chạy Test Booking Confirmation

Chọn test event `test-booking-confirmation` và click **Test**:

![](/images/5-workshop/5.email/012-run-test-booking.png?width=90pc)

Bạn đã hoàn thành việc test Lambda function! Tiếp theo chuyển sang [5.5.3 - Setup API Gateway](../5.5.3-setup-api-gateway).