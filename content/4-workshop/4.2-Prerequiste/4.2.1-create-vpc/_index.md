...
4. Sau khi tạo thành công, chọn **View VPC** để xem chi tiết
...
{{% notice tip %}}
VPC wizard sẽ tự động tạo Internet Gateway, S3 Gateway Endpoint, Route Tables và associate subnets. NAT Gateway sẽ được tạo thủ công ở bước 4.6.3.
{{% /notice %}}
...
{{% notice info %}}
**Quan trọng:** Hãy ghi lại chính xác IPv4 CIDR của **Public Subnet AZ 1a** này. Bạn sẽ cần sử dụng nó để cấu hình Security Group cho Admin Service ở bước 4.6.1.
{{% /notice %}}
