...
{{% notice info %}}
NAT Gateway sẽ được tạo sau ở bước 4.6.3 khi cần thiết cho private subnet.
{{% /notice %}}

#### Nội dung

1. [Tạo VPC và Network](4.2.1-create-vpc/)
2. [Tạo IAM Role cho EC2](4.2.2-create-iam-role/)
3. [Tạo IAM User và Access Keys](4.2.3-create-access-keys/)
