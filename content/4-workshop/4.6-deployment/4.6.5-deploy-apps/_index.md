...
![](/Internship-report-aws/images/5-workshop/6.deployment/046-clone.png?width=90pc)
...
![](/Internship-report-aws/images/5-workshop/6.deployment/047-npm.png?width=90pc)
...
![](/Internship-report-aws/images/5-workshop/6.deployment/048-env.png?width=90pc)
...
pm2 save
```
![](/Internship-report-aws/images/5-workshop/6.deployment/052-pm2.png?width=90pc)
...
![](/Internship-report-aws/images/5-workshop/6.deployment/053-admin.png?width=90pc)
...
![](/Internship-report-aws/images/5-workshop/6.deployment/054-admin-install.png?width=90pc)
...
![](/Internship-report-aws/images/5-workshop/6.deployment/055-admin-env.png?width=90pc)
...
![](/Internship-report-aws/images/5-workshop/6.deployment/056-admin-pm2.png?width=90pc)
...
![](/Internship-report-aws/images/5-workshop/6.deployment/090-tg.png?width=90pc)

- **Targets** tab → **Register targets**

![](/Internship-report-aws/images/5-workshop/6.deployment/091-tg.png?width=90pc)

- Chọn Customer Service instance
- **Port**: `3000`
- Click **Include as pending below** → **Register pending targets**
![](/Internship-report-aws/images/5-workshop/6.deployment/092-tg.png?width=90pc)

- Xác nhận kết quả sau khi register

![](/Internship-report-aws/images/5-workshop/6.deployment/100-tg.png?width=90pc)

2. Thêm Admin Service instance:

- Chọn `carbuyer-admin-employee-tg`

![](/Internship-report-aws/images/5-workshop/6.deployment/093-tg.png?width=90pc)

- **Targets** tab → **Register targets**
- Chọn Admin Service instance
- **Port**: `3001`

![](/Internship-report-aws/images/5-workshop/6.deployment/094-tg.png?width=90pc)

- Click **Include as pending below** → **Register pending targets**

- Xác nhận kết quả sau khi register

![](/Internship-report-aws/images/5-workshop/6.deployment/101-tg.png?width=90pc)
...
![healthy](/Internship-report-aws/images/5-workshop/6.deployment/098-health.png?width=90pc)

![healthy](/Internship-report-aws/images/5-workshop/6.deployment/099-health.png?width=90pc)
